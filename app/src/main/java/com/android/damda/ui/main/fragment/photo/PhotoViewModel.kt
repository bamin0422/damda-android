...
class PhotoViewModel : ViewModel() {
    val photoData = MutableLiveData<MutableList<ImgItem>>()
    private var data = mutableListOf<ImgItem>()

    /**
     * getPhotoData : LiveData인 memoryData의 value 값을 리턴
    ...
    /**
     * addPhotoData : 특정 ImgItem 추가하는 function
     * */
    fun addPhotoData(memData : ImgItem){
        data.add(memData)
        photoData.value = data
    }

    /**
     * addPhotoDatas : 여러 ImgItem 추가하는 function
     * */
    fun addPhotoDatas(memoryDatas : MutableList<ImgItem>){
        memoryDatas.forEach{
            data.add(it)
        }
        photoData.value = data
    ...
    /**
     * deletePhotoData : 특정 ImgItem 삭제하는 function
     * */
     ...
     * */
    fun deletePhotoDatas(phDatas : MutableList<ImgItem>){
        phDatas.forEach{
            data.remove(it)
        }
        photoData.value = data
